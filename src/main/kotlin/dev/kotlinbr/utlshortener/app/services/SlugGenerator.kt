...
class SlugGenerator(private val repo: LinksRepository) {
    private val base62 = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"

    fun generate(length: Int = 7, maxRetries: Int = 5): String {
        var lastTried = ""
        repeat(maxRetries) {
        ...
        throw IllegalStateException("Falha ao gerar slug único após" +
            " $maxRetries tentativas. Último tentado: $lastTried")
    }
